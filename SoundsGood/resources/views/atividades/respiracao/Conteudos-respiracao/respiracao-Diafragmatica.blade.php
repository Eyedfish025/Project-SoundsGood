{{-- resources/views/respiracao-diafragmatica.blade.php --}}
@extends('layouts.app')

@section('title', 'SoundsGood - Respiração Diafragmática')
...
<main class="container my-2 pt-5">
    <header class="text-center my-2 reveal">
        <h1 class="display-4 hero-title">Respiração Diafragmática</h1>
        <p class="lead text-white-50 hero-subtitle">
            Concentre-se em expandir o abdômen ao inspirar e contraí-lo ao expirar. Toque para começar.
        </p>
    </header>
...
<script>
    ...
    function startBreathCycle() {
        ...
        runPhase('Inspire (4s)', 4, 'breathing-inspire phase-inspire', () => {
            runPhase('Expire (6s)', 6, 'breathing-expire phase-expire', startBreathCycle);
        });
    }
