{{-- resources/views/respiracao.blade.php --}}
@extends('layouts.app')

@section('title', 'SoundsGood - Respiração 4-7-8')
...
<main class="container my-2 pt-5">
    <header class="text-center my-2 reveal">
        <h1 class="display-4 hero-title">Respiração 4-7-8</h1>
        <p class="lead text-white-50 hero-subtitle">
            Inspire por 4s, segure por 7s e expire por 8s. Toque no círculo para começar.
        </p>
    </header>
...
<script>
    ...
    function startBreathCycle() {
        ...
        runPhase('Inspire', 4, 'breathing-inspire', () => {
            runPhase('Segure', 7, 'breathing-hold', () => {
                runPhase('Expire', 8, 'breathing-expire', startBreathCycle);
            });
        });
    }
