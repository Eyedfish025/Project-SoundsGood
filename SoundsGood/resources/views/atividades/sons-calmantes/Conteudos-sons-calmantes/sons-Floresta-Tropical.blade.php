...
<main class="container my-5 pt-5">
    <header class="text-center my-5 reveal">
        <h1 class="display-4 hero-title">Sons Calmantes De Floresta Tropical</h1>
    ...
    <section class="sounds-section reveal">
        <div class="row justify-content-center text-center">
            @foreach(['Floresta 1','Floresta 2','Floresta 3','Floresta 4','Floresta 5','Floresta 6'] as $sound)
...
<!-- Footer é puxado pelo layout -->SoundsGood/public/audios/Sons-Calmantes/Floresta-leve/Floresta-1.mpeg

<!-- Áudios -->
<!-- Som Floresta 1 -->
<audio id="audio-Floresta 1" loop>
    <source src="audios/Sons-Calmantes/Floresta-Tropical/" type="audio/mpeg">
</audio>
<audio id="audio-Floresta 2" loop>
    <source src="audios/Sons-Calmantes/Floresta-Tropical/" type="audio/mpeg">
</audio>
<audio id="audio-Floresta 3" loop>
    <source src="audios/Sons-Calmantes/Floresta-Tropical/" type="audio/mpeg">
</audio>
<audio id="audio-Floresta 4" loop>
    <source src="audios/Sons-Calmantes/Floresta-Tropical/" type="audio/mpeg">
</audio>
<audio id="audio-Floresta 5" loop>
    <source src="audios/Sons-Calmantes/Floresta-Tropical/" type="audio/mpeg">
</audio>
<audio id="audio-Floresta 6" loop>
    <source src="audios/Sons-Calmantes/Floresta-Tropical/" type="audio/mpeg">
</audio>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content custom-modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control custom-input" id="soundNameInput" placeholder="Ex: Floresta na Janela">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secFlorestary" data-bs-dismiss="modal">Cancelar</button>
