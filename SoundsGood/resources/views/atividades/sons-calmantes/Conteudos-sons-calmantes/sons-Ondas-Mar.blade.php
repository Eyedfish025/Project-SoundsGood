...
<main class="container my-5 pt-5">
    <header class="text-center my-5 reveal">
        <h1 class="display-4 hero-title">Sons Calmantes De Ondas Do Mar</h1>
    ...
    <section class="sounds-section reveal">
        <div class="row justify-content-center text-center">
            @foreach(['Onda 1','Onda 2','Onda 3','Onda 4','Onda 5','Onda 6'] as $sound)
...
<!-- Footer é puxado pelo layout -->SoundsGood/public/audios/Sons-Calmantes/Onda-leve/Onda-1.mpeg

<!-- Áudios -->
<!-- Som Onda 1 -->
<audio id="audio-Onda 1" loop>
    <source src="audios/Sons-Calmantes/Onda-Mar/Onda-mar-1.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-Onda 2" loop>
    <source src="audios/Sons-Calmantes/Onda-Mar/Onda-mar-2.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-Onda 3" loop>
    <source src="audios/Sons-Calmantes/Onda-Mar/Onda-mar-3.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-Onda 4" loop>
    <source src="audios/Sons-Calmantes/Onda-Mar/Onda-mar-4.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-Onda 5" loop>
    <source src="audios/Sons-Calmantes/Onda-Mar/Onda-mar-5.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-Onda 6" loop>
    <source src="audios/Sons-Calmantes/Onda-Mar/Onda-mar-6.mpeg" type="audio/mpeg">
</audio>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content custom-modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control custom-input" id="soundNameInput" placeholder="Ex: Onda na Janela">
            </div>
