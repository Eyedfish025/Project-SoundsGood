...
<main class="container my-5 pt-5">
    <header class="text-center my-5 reveal">
        <h1 class="display-4 hero-title">Sons Calmantes De Chuva Leve</h1>
    ...
    <section class="sounds-section reveal">
        <div class="row justify-content-center text-center">
            @foreach(['chuva 1','chuva 2','chuva 3','chuva 4','chuva 5','chuva 6'] as $sound)
...
<!-- Footer é puxado pelo layout -->SoundsGood/public/audios/Sons-Calmantes/Chuva-leve/Chuva-1.mpeg

<!-- Áudios -->
<!-- Som Chuva 1 -->
<audio id="audio-chuva 1" loop>
    <source src="audios/Sons-Calmantes/Chuva-leve/Chuva-1.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-chuva 2" loop>
    <source src="audios/Sons-Calmantes/Chuva-leve/Chuva-2.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-chuva 3" loop>
    <source src="audios/Sons-Calmantes/Chuva-leve/Chuva-3.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-chuva 4" loop>
    <source src="audios/Sons-Calmantes/Chuva-leve/Chuva-4.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-chuva 5" loop>
    <source src="audios/Sons-Calmantes/Chuva-leve/Chuva-5.mpeg" type="audio/mpeg">
</audio>
<audio id="audio-chuva 6" loop>
    <source src="audios/Sons-Calmantes/Chuva-leve/Chuva-6.mpeg" type="audio/mpeg">
</audio>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content custom-modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control custom-input" id="soundNameInput" placeholder="Ex: Chuva na Janela">
            </div>
